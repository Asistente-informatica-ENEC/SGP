...
use App\Orchid\Layouts\BadConditionCard\BadConditionCardEditLayout;
...
class BadConditionCardEditScreen extends Screen
{
    /**
    ...
    {
        return $this->responsabilityCard->exists ? 'Editar Tarjeta de Mal Estado' : 'Crear Nueva Tarjeta de Mal Estado';
    }
    ...
    {
        return [
            BadConditionCardEditLayout::class,
        ...
        DB::transaction(function () use ($responsabilityCard, $data, $assetIds, $observations) {
            ...
            foreach ($chunks as $chunkAssetIds) {
                ...
                foreach ($chunkAssetIds as $aId) {
                    ...
                    Asset::where('id', $aId)->update(['state' => 'EN MAL ESTADO']);
                }
            }
        });

        Alert::info('Tarjeta de mal estado guardada exitosamente.');
